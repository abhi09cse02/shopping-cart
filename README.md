...
Step 4: In Select an App Section: select Other (custom name) => enter "Electronics Shopping Cart" => Generate
...
Step 2: Click On File > Import > Git > Projects From Git > Clone Uri > Paste The Repository Url as: ```https://github.com/abhi09cse02/shopping-cart.git```> Select master Branch > Next > Next > Finish.
